...
async function generateContent() {
  ...
  if (query.toLowerCase().includes("thala") || query.toLowerCase().includes("dhoni") || query.toLowerCase().includes("msd")) {
...
async function shareOnOthers() {
  document.documentElement.style.backgroundColor = "rgb(115, 144, 114)";
  document.body.style.backgroundColor = "rgb(115, 144, 114)";
  const mainContainer = document.querySelector(".main-container");

  // Make the background of the main container transparent
  mainContainer.style.backgroundColor = "rgb(115, 144, 114)";
